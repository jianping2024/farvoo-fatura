...
func TestRouteAuthFor_M32cTiers(t *testing.T) {
	cases := []struct {
		...
		{"POST", "/local/v1/setup/terminals/abc/activate", authManager},
		{"POST", "/local/v1/setup/terminals/abc/delete", authManager},
		{"PUT", "/local/v1/setup/terminals/abc/station", authManager},
		{"PUT", "/local/v1/setup/print-station/local", authManager},
		{"GET", "/local/v1/setup/print-station", authSession},
